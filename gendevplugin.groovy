...
def BASE_SCAN_ROOT = 'SAF_DevPlugin'
...
def zipFile = new File(outDir, 'SAF_DevPlugin.zip')
...
if (pluginDir.exists() && pluginDir.isDirectory()) {
    ...
    println "No SAF_DevPlugin directory found to zip (looked at: ${pluginDir.absolutePath})"
}
